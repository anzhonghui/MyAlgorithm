...
public class LongestPalindromicSubstring {
	...
	@Test
	public void MyTest() {
		System.out.println(longestPalindromeByMe("babad"));
		System.out.println(longestPalindromeByMe("cbbd"));
		System.out.println(longestPalindromeByMe("a"));
		System.out.println(longestPalindromeByMe("ac"));
		System.out.println(longestPalindromeByMe("bb"));
		System.out.println(longestPalindromeByMe("baaab"));
		System.out.println(longestPalindromeByMe("abcda"));
		System.out.println(longestPalindromeByMe(""));
	}
...
//			}
	...
	// 动态规划
	public String longestPalindromeByDy(String s) {
		if (s == null) {
			return null;
		}
